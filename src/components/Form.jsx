...
const FormComponent = () => {
  return (
    <>
   <div className=''>
    <img className=' opacity-75 '  src="src/assets/imgs/background-full/banner-4.jpg" alt="" />
</div>
   <div className=' relative py-0 bottom-[43rem] float-right flex w-1/2 justify-center items-center'>

   
<div className="min-h-screen  py-1 flex flex-col justify-center sm:py-12">
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div className="max-w-md mx-auto">
				<div>
					<h1 className="text-2xl font-bold">BOOK YOUR ORDER</h1>
				</div>
				<div className="divide-y divide-gray-200">
					<div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<div className="relative">
							<button className="bg-customRed text-white rounded-md px-5 py-2">Submit</button>
						</div>
					</div>
				</div>
			</div>
